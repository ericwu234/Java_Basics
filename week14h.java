...
class Minemap {
    ...
    private boolean openMap(int x, int y, char s) {
        ...
        current_map[y][x]=map.getPoint(x, y);
        // this.space_num--;
    ...
    //            // canvas[i][j] = c;
    //            if(display_map.canvas[i][j]=='E')
    //            current_map[y][x]=0;
    //            if(display_map.canvas[i][j]=='F')
    //                current_map.setPoint(j,i,11);
    //            if(display_map.canvas[i][j]=='m')
    //                current_map.setPoint(j,i,10)
    //            else
    ...
    public boolean touchThePoint(int act,int x,int y){
        if(act==1)
        {
            touchEvent(x, y);
            return true;
